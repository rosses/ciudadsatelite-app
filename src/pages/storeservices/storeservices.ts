...
@Component({
  selector: 'page-storeservices',
  templateUrl: 'storeservices.html',
})
export class StoreServices {
  ...
  cargarServicios() {
    ...
    this.loaded = false;
    this.doctorService.getServices(this.store.id).subscribe((data:any)=> {
      this.loaded = true;
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: () => {
            ...
            this.doctorService.delService(product.id).subscribe((data:any) => {
              this.service.showOk();
              this.cargarServicios();
            });
  ...
  save() {
      ...
      let updateOperation = this.doctorService.setService(this.edit);
